...
=for HTML <p><img src="https://secure.travis-ci.org/USGCRP/gcis-sync.png" alt="Build status" /></p>

=head1 DESCRIPTION

sync.pl pulls data from a variety of sources, and ingests the data into the L<GCIS|http://data.globalchange.gov>.

The mechanism for pulling from the various sources varies, and is described in
the documentation for a particular "syncer".

Please see L<sync.pl|https://github.com/USGCRP/gcis-sync/blob/master/sync.pl> for usage
of the command line synchronization utility.
